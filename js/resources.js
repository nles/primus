game.resources = [
  ...
  {name: "collector", type:"image", src: "data/img/sprite/rubber.png"},
  // the faller spritesheets
  {name: "faller", type:"image", src: "data/img/sprite/fire.png"},
  ...
  // images for the settings screen
  {name: "arrow", type:"image", src: "data/img/title/arrow.png"},
  {name: "doublearrow", type:"image", src: "data/img/title/doublearrow.png"},
  // the rest of the buttons
  {name: "cancel", type:"image", src: "data/img/title/cancel.png"},
  {name: "confirm", type:"image", src: "data/img/title/confirm.png"},
  {name: "settings", type:"image", src: "data/img/title/settings.png"},
